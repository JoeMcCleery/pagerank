...
def transition_model(corpus, page, damping_factor):
    ...
    if num_links == 0:
        ...
        # Populate probability distribution
        for p in corpus:
            # If current page is linked to on page
            if p in corpus[page]:
                # Set chance to link_chance add random_chance
                dist[p] = link_chance + random_chance
            else:
                # Set chance to random_chance
                dist[p] = random_chance
    return dist
